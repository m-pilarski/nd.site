...
{{{< div class="grid py-2" >}}} 
    ...
    {{{< /div >}}} 
    {{{< div class="g-col-12 g-col-md-6 g-col-xl-4" >}}} 
        {{{< bs_card_emoji emoji_code="2b50" emoji_bg="#837591" card_title="Kundenrezensionen" card_text="Kundenrezensionen bieten wertvolle Einblicke in die Nutzung und Bewertung von Produkten, oft jedoch in unstrukturierter Form. Mittels Textanalyse lassen sich diese Informationen systematisch aufbereiten und helfen, Nutzerbedürfnisse gezielt zu erkennen." card_href="/case_studies/customer_reviews" >}}}
    {{{< /div >}}} 
    {{{< div class="g-col-12 g-col-md-6 g-col-xl-4" >}}} 
        {{{< bs_card_emoji emoji_code="1f4e9" emoji_bg="#837591" card_title="Analyse von Support-Tickets" card_text="Täglich erreichen Unternehmen zahlreiche Anfragen, Beschwerden oder sonstige Mitteilungen. Um diese effizient zu verwalten, kommen Support-Systeme zum Einsatz, die Kundenanliegen strukturieren und kategorisieren." >}}}
    {{{< /div >}}} 
    {{{< div class="g-col-12 g-col-md-6 g-col-xl-4" >}}} 

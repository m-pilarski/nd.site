...
# card_test <- tags$div(
#   tags$div(
#     "Beispiel einer Beobachtung aus dem Rohdatensatz", 
#     class="card-header"
#   ),
#   tags$ul(
#     tags$li(tags$em("Titel:"), "Das Beste iPhone aller Zeiten", class="list-group-item"),
#     tags$li(tags$em("Datum:"), "5. Januar 2020", class="list-group-item"),
#     tags$li(tags$em("Inhalt:"), "Ich bin sehr zufrieden mit dem iPhone 11. Der Wechsel vom iPhone 6s war ein riesiger Quantensprung, der sich allerdings gelohnt hat. Ich würde es jederzeit wieder kaufen.", class="list-group-item"),    
#     tags$li(tags$em("Bewertung:"), htmltools::HTML("<i class='fa-solid fa-star'></i>&nbsp;<i class='fa-solid fa-star'></i>&nbsp;<i class='fa-solid fa-star'></i>&nbsp;<i class='fa-solid fa-star'></i>&nbsp;<i class='fa-regular fa-star'></i>"), class="list-group-item"),
#     tags$li(tags$em("URL:"), tags$a("https://www.amazon.de/Apple-iPhone-11-128-GB-Schwarz/product-reviews/B07XRFCP6G/ref=cm_cr_arp_d_paging_btm_10?ie=UTF8&filterByStar=positive&pageNumber=10&reviewerType=all_reviews", href="https://www.amazon.de/Apple-iPhone-11-128-GB-Schwarz/product-reviews/B07XRFCP6G/ref=cm_cr_arp_d_paging_btm_10?ie=UTF8&filterByStar=positive&pageNumber=10&reviewerType=all_reviews"), class="list-group-item"),
...
# # Wrap for Glider.js
# glider_container <- tags$div(
#   class = "glider-container",
#   tags$div(class = "glider", cards),
#   tags$button(class = "glider-prev", "«"),
#   tags$button(class = "glider-next", "»"),
#   # tags$div(class = "dots")
# )

# # Optional: JS initialization (assumes you're loading glider.min.js separately)
# glider_init <- tags$script(htmltools::HTML(
...
# glider_css <- tags$style(HTML(paste(
#   ".glider-container {",
#   "  position: relative;",
#   "  padding: 1rem;",
#   "}",
...
# tagList(glider_css, glider_container, glider_init)
```

```{r}
library(htmltools)

# Create cards with wrapper for spacing
create_card <- function(title, date, content) {
  tags$div(
    class = "card",
    tags$div(title, class = "card-header"),
    tags$ul(
      class = "list-group list-group-flush",
      tags$li(tags$em("Datum:"), " ", date, class = "list-group-item"),
      tags$li(tags$em("Inhalt:"), " ", content, class = "list-group-item")
    )
  )
}
...
# Example cards
cards <- tagList(
  create_card("Beispiel 1", "5. Jan 2020", "Sehr zufrieden mit dem iPhone."),
  create_card("Beispiel 2", "6. Jan 2020", "Tolles Gerät."),
  create_card("Beispiel 3", "7. Jan 2020", "Gute Akkulaufzeit."),
  create_card("Beispiel 4", "8. Jan 2020", "Preis-Leistung passt.")
)

# HTML structure with buttons underneath
glider_container <- tagList(
  tags$div(
    class = "glider-container",
    tags$div(class = "glider", cards),
  ),
  tags$div(
    ...
    tags$button(id="glider-prev1", type="button", class="btn btn-light", htmltools::HTML("<i class='fa-solid fa-angles-left'></i>")),
    tags$button(id="glider-next1", type="button", class="btn btn-light", htmltools::HTML("<i class='fa-solid fa-angles-right'></i>"))
  )
)

# JavaScript for Glider initialization
glider_js <- tags$script(HTML("
  document.addEventListener('DOMContentLoaded', function () {
    // Wait a bit to ensure DOM is fully ready
    setTimeout(function() {
      const gliderElement = document.querySelector('.glider');
      if (gliderElement && typeof Glider !== 'undefined') {
        ...
        console.error('Glider element or Glider.js library not found');
      }
    }, 100);
  });
"))

# Render everything (no CDN needed since Glider.js is already loaded)
tagList(glider_container, glider_js)
```

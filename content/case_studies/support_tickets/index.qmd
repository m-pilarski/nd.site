...
format_token <- function(.tok) {
  htmltools::tagList(
    htmltools::tags$p(
      class = "token-stream mb-0 pb-0",
      purrr::map(.tok, htmltools::span, class = "badge token text-bg-primary")
    ),
    htmltools::tags$style(stringi::stri_c(
      ".token-stream .badge.token {",
      "  padding: .15rem .4rem;",
...
tags$div(
  ...
  tags$div(
    ...
    htmltools::tags$p(class = "pb-0", msg_full)
  ),
